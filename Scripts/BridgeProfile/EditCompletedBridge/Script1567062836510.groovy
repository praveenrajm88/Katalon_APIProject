...
break
	...
	//	WebUI.scrollToElement(findTestObject('BridgeProfile/ProfileAddRowButton', 10))
		...
		String[] fromExcelCFGList= new String[5]
			...
			for (int i = 0; i < 5; i++) {
				(fromExcelCFGList[i]) = findTestData('AutoBridgeDataFile/ProfileCFGListData').getValue(i + 1, 1)
			}
		
			for (int tRow = 2; tRow <=5; tRow++) {
				...
				driver.findElement(By.xpath('//*[@class="bridge-profile-holder"]/table/tr['+ tRow +']/td[2]/mat-form-field/div/div/div/input')).sendKeys(fromExcelCFGList[1].toString())
					
				driver.findElement(By.xpath('//app-consences[@mode="show"]/mat-card/mat-card-content/table/tr['+ tRow +']/td[5]/mat-form-field/div/div/div[3]/input')).sendKeys(fromExcelCFGList[2].toString())
